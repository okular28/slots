export const RendererConfig = {
    ...
    /* Reel jest stackiem */
    reelSet: [
        [5, 2, 1, 4, 3, 6, 7, 7, 8, 9, 0, 3, 2, 2, 1, 6], //0 one maja mieć długość ok. 50 indexów
        [5, 2, 1, 4, 3, 6, 7, 7, 8, 9, 0], //1
        [5, 2, 1, 4, 3, 6, 7, 7, 8, 9, 0], //2
        [5, 2, 1, 4, 3, 6, 7, 7, 8, 9, 0], //3
        [5, 2, 1, 4, 3, 6, 7, 7, 8, 9, 0] //4
    ],
